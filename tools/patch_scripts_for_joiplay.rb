...
#  15. File/Dir.exist?:         (DISABLED — JoiPlay Ruby supports exist?, removed exists?)
...
def patch_ruby19_apis(line)
  ...
  # 9. File.exist? / Dir.exist? — keep as-is; JoiPlay's Ruby supports exist? and has removed exists?
